...
The **Mapped predictions** provides a visual look at the distribution of adjusted R2 values (i.e., model strength) across the ecoregions of the boreal region of Canada.

<br>

#### Observed vs fitted

The **Observed vs fitted** tab plots the relationship between observed KS values and predicted (fitted) KS values. A good model would be characterized by an upward linear relationship and show a clear separation between representative (teal) vs non-representative (red) networks.

<br>

#### Coefficient boxplots

The **Coefficients boxplots** tab uses boxplots to show the distribution of ecoregion-level surrogate coefficients within ecozones.

<br>

#### Explanatory factors

The **Explanatory factors** tab uses bloxplots and scatterplots to show the distribution of ecoregion-level adjusted R2 values against ecozones, intactness, network size (approximated by MDR), and density.
