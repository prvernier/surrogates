...
write_csv(y1a, 'output/obj3_bcr_birds.csv')
...
write_csv(y1b, 'output/obj3_bcr_birds_full_output.csv')
...
y2a = filter(x, ecoregion %in% eco_list) %>% 
    ...
    count(surrogate) %>%
    spread(surrogate, n, fill=0)
write_csv(y2a, 'output/obj3_bcr_caribou.csv')
...
write_csv(y2b, 'output/obj3_bcr_caribou_full_output.csv')
